        ...
        <div class="block__body bg-white body_main">
            <form method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[group_id]" placeholder="2312315" value="<?= $config->group_id?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[group_secret]" placeholder="fdafEFfgdag" value="<?= $config->group_secret?>">
                        <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                             data-placement="bottom" title="Ключ для проверки, что callback ришел именно от ВК. Берется в настройках callback в группе.">
                            i
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[group_confirm]" placeholder="wgrerg" value="<?= $config->group_confirm?>">
                    </div>
                    <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                         data-placement="bottom" title="Строка, которая должна вернутся для подтверждения Callback url. Берется там же в настройках группы.">
                        i
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[topic_id]" placeholder="21415431" value="<?= $config->topic_id?>">
                        <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                             data-placement="bottom" title="Топик, куда будут поститься автоматическуие ответы и результаты конкурса.">
                            i
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[app_id]" placeholder="2341341" value="<?= $config->app_id?>">
                        <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                             data-placement="bottom" title="ID приложения конкурса. Лучше его не трогать на самом деле.">
                            i
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[app_secret]" placeholder="afAUifeir232FAd" value="<?= $config->app_secret?>">
                        <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                             data-placement="bottom" title="Секретный ключ этого приложения. Тоже на всякий случай стоит оставить как есть.">
                            i
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="Config[standalone_id]" placeholder="32354341" value="<?= $config->standalone_id?>">
                        <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                             data-placement="bottom" title="Это айди приложения, занимающегося автоответом в топике. Для него требуется другой ключ.">
                            i
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div data-toggle="tooltip" class="input-group-addon tooltip-default"
                             data-placement="bottom" title="Тут все просто - куда редиректим после авторизации. Тоже программистские штучки.">
                            i
                        </div>
                    </div>
                </div>
